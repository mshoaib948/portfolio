...
// use these statement to show error on php.
error_reporting(E_ALL);
ini_set('display_errors', 1);

// Initialize variables
$productname = $customername = $contactno = $address = $country ="";
    
// if condition use if want to open direct php files from localhost
if (!$_POST)
    {
        echo"go to form and follow the process";
        ?>

<!-- html add here just for button icon. -->
<html>
    <head></head>
    <body>
        <a href="./order.html">button</a>
    </body>
</html>
...
if ($conn->connect_error) {
    ...
    echo "<div class='success-box'>Order Received</div>";
}

// Insert query
$sql = "INSERT INTO pizza_orders (productname, customername, contactno, address, country)
        VALUES ('$productname', '$customername', '$contactno', '$address', '$country')";

if ($conn->query($sql) === TRUE) {
    echo "<div class='success-box'>Order Confirmed.</div>";
} else {
...
echo "<h2 class='order-heading'>Order Details:</h2>";
echo "<p><span class='label'>Product Name:</span> $productname</p>";
echo "<p><span class='label'>Customer Name:</span> $customername</p>";
echo "<p><span class='label'>Contact No:</span> $contactno</p>";
echo "<p><span class='label'>Address:</span> $address</p>";
echo "<p><span class='label'>Country:</span> $country</p>";
echo "</div>";
?>
