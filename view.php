...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>
          ...
          <td>".$row["address"]."</td>
          <td>".$row["country"]."</td>
          <td><a class='btn-update' href='update.php?id=".$row["id"]."'>Update</a></td>
          <td><a class='btn-delete' href='delete.php?id=".$row["id"]."'>Delete</a></td>
        </tr>";
    }
    echo "</table>";
} else {
    echo "<div class='info-box'>No orders found.</div>";
}
